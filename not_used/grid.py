# Tracking spots within each frame to determine if they are empty or occupied
import cv2
import numpy as np
...
mask = '../datasets/mask/frame_1 (1).png'
...
while ret:
    ...
    cv2.putText(frame, 'Available parts: {} / {}'.format(str(sum(spots_status)), str(len(spots_status))), (100, 60),
